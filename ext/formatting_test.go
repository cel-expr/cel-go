...
func TestStringFormat(t *testing.T) {
	tests := []struct {
...

		{
			...
			expectedEstimatedCost: cost.FixedCostEstimate(13),
		},
		{
		...
		},
		{
			...
			expectedEstimatedCost: cost.FixedCostEstimate(14),
		},
		{
		...
		},
		{
			...
			expectedEstimatedCost: cost.FixedCostEstimate(21),
			locale:                "en_US",
		},
		{
		...
		},
		{
			...
			expectedEstimatedCost: cost.FixedCostEstimate(15),
			locale:                "en_US",
		},
		{
		...
		},
		{
			...
			expectedEstimatedCost: cost.FixedCostEstimate(32),
		},
		{
			...
			expectedEstimatedCost: cost.FixedCostEstimate(42),
		},
		{
			...
			expectedEstimatedCost: cost.FixedCostEstimate(46),
		},
		{
